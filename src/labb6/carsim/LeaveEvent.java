...
/**
 * Ett event som representerar att en bil lämnar biltvätten. Om det finns bilar
 * i kön tilldelas nästa bil direkt till den frigjorda maskinen, annars blir
 * maskinen ledig.
 *
...
public class LeaveEvent extends CarWashEvent {
	...
	/**
	 * Om det finns bilar i kön tilldelas nästa bil direkt till den frigjorda
	 * maskinen, annars blir maskinen ledig.
	 *
