...
/**
 * Ett event som representerar att en bil anländer till biltvätten. Om det finns
 * en ledig maskin skickas bilen dit, annars ställs den i kön. Efter ankomsten
 * skapas nästa ArriveEvent.
 *
...
public class ArriveEvent extends CarWashEvent {
	...
	/**
	 * Skickar bilen till en ledig maskin om det finns, annars läggs bilen till i
	 * kön eller avvisas.
	 *
