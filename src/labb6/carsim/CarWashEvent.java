...
public abstract class CarWashEvent extends Event {
	...
	/**
	 * Konstruktor för CarWashEvent. Används för att skapa gemensamma fält, och för
	 * att behålla arvshirarkin.
	 *
	...
	/**
	 * Skickar en bil till en tvättmaskin och skapar ett {@code LeaveEvent} för när
	 * bilen är färdigtvättad.
	 *
