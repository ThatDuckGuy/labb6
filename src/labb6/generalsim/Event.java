...
/**
 * Abstrakt klass som representerar en generell händelse i simuleringen.
 * Varje händelse har en tid när händelsen inträffar, och varje händelse påverkar state.
 * Händelser ordnas utifrån denna tid genom {@Code comparable}.
 *
...
public abstract class Event implements Comparable<Event> {
    ...
    /**
     * Jämför en händelse (this) med en annan (other) baserat 
     * på tid, och avgör vilken som inträffar först.
     *
    ...
    /**
     * Utför händelsens effekt på simuleringens tillstånd (State s).
     * Konkretiseras av varje implementation till Event.
     *
