...
/**
 * En diskret simulator. Hanterar en eventQueue och ser till att händelser
 * inträffar. Klassen är helt oberoende av vad som simuleras.
 *
...
public class Simulator implements EventQueue {
	...
	/**
	 * Startar simuleringen och kör eventen i kronologisk ordning tills händelsekön
	 * är tom eller simuleringen stoppas.
	 */
	public void run() {
